---
title: '''캡틴 토트넘'' 손흥민, 개막전서 PK 헌납...평점 10점 만점에 6.1점'
description: '9월 14일 브렌트포드와의 개막전 2-2 무승부'
category: 'Sports'
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. 토트넘과 브렌트포드의 경기 최종 스코어는 어떻게 되었나요?</b></h2>
  ...
  <p>토트넘과 브렌트포드의 경기는 2-2 무승부로 끝났습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 토트넘의 첫 골은 누가 넣었나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>크리스티안 로메로가 토트넘의 선제골을 넣었습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 페널티 박스 안에서 마티아스 옌센에게 반칙을 한 선수는 누구인가요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>손흥민이 페널티 박스 안에서 마티아스 옌센에게 파울을 범했습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 브렌트포드의 페널티킥은 누가 득점했나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>브라이언 음벰보가 브렌트포드의 페널티킥을 성공시켰습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 이날 경기에서 손흥민의 활약은 어땠나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>손흥민은 이 경기에서 페널티킥을 허용하고 슈팅이 단 한 차례에 그치는 등 실망스러운 경기력을 보였습니다.</p>
</details>
