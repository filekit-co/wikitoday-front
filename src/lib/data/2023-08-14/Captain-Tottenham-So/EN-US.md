---
title: '''Captain Tottenham'' Son Heung-min dedicates PK in opener...Rating 6.1 out of 10 reviews'
description: '2-2 opening day draw with Brentford on Sept. 14'
category: 'Sports'
keywords: '토트넘, 손흥민, 손흥민 주장, 토트넘 손흥 민'
date: '2023-08-14'
author: 'wikitoday.io'
language: 'EN-US'
candidLanguages: ['EN-US', 'ZH', 'KO']
thumbnail: 'https://flexible.img.hani.co.kr/flexible/normal/900/600/imgdb/original/2023/0814/20230814500053.jpg'
---

# ''Captain Tottenham'' Son Heung-min dedicates PK in opener...Rating 6.1 out of 10 reviews

<p class="datetime"><em>2023-08-14 - wikitoday<em></p>

<blockquote class="quote-container dark">
  <p class="quote-text dark">
    2-2 opening day draw with Brentford on Sept. 14
  </p>
</blockquote>


<figure class=image-container>
    <img src="https://flexible.img.hani.co.kr/flexible/normal/900/600/imgdb/original/2023/0814/20230814500053.jpg" alt="한겨레" />
    <figcaption>
        <h4> from 한겨레</h4>
    </figcaption>
</figure>
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. What was the final score of the match between Tottenham and Brentford?</b></h2>
  ...
  <p>The match between Tottenham and Brentford ended in a 2-2 draw.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Who scored the opening goal for Tottenham?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Christian Romero scored the opening goal for Tottenham.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Who fouled Matthias Jensen inside the penalty box?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Son Heung-min fouled Matthias Jensen inside the penalty box.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Who scored the penalty for Brentford?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Brian Mbembo scored the penalty for Brentford.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What was Son Heung-min&#39;s performance like in the match?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Son Heung-min had a disappointing performance in the match, conceding a penalty and being limited to just one shot on target.</p>
</details>
