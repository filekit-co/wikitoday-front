...
description: '[포포투=가동민 기자] 분데스리가 사무국이 김민재가 바이에른 뮌헨의 주전 선발로 나설 것으로 내다봤다. 분데스리가는 12일(한국시간) 공식 홈페이지를 통해 올 시즌 뮌헨의 예상 선발 11인 명단을 발표했다. 포메이션은 4-2-3-1로, 최전방에는 케인이, 2선에는 킹슬리 코가 배치될 예정이다.'
category: 'Sports'
keywords: '뮌헨'
date: '2023-08-14'
author: 'wikitoday.io'
...
<blockquote class="quote-container dark">
  <p class="quote-text dark">
    [포포투=가동민 기자] 분데스리가 사무국이 김민재가 바이에른 뮌헨의 주전 선발로 나설 것으로 내다봤다. 분데스리가는 12일(한국시간) 공식 홈페이지를 통해 올 시즌 뮌헨의 예상 선발 11인 명단을 발표했다. 포메이션은 4-2-3-1로, 최전방에는 케인이, 2선에는 킹슬리 코가 배치될 예정이다.
  </p>
</blockquote>
...
<details class="group" open>
  ...
  <p>이번 시즌 뮌헨의 예상 베스트 11에는 김민재, 해리 케인, 킹슬리 코만, 자말 무사우이, 세르주 그나브리, 조슈아 키미히, 콘라드 라이머, 알폰소 데이비스, 마티아스 데 리흐트, 빈센트 파바르드, 스벤 울라이히가 포함됩니다.</p>
</details>
...
<details class="group" >
  ...
  <p>뮌헨은 지난해 분데스리가 타이틀 방어에 실패하며 실망스러운 시즌을 보냈습니다. 도르트문트가 1위 자리를 차지했고 뮌헨은 시즌 내내 추격전을 펼쳤습니다. 또한 UEFA 챔피언스 리그와 DFB 포칼의 8강에서 모두 탈락했습니다.</p>
</details>
...
<details class="group" >
  ...
  <p>공격 강화를 위해 뮌헨은 토트넘에서 해리 케인을 영입했습니다. 수비에서는 다요 우파메카노의 공백을 메우기 위해 나폴리에서 김민재를 영입했습니다.</p>
</details>
...
사진=문헨 [푸터=김동민] 분데스리가 사무국은 김동민이 바이에른 뮌헨의 주전으로 선발 출전할 것으로 보고 있다.

 해리 케인도 마찬가지다. 분데스리가는 수요일 공식 홈페이지를 통해 올 시즌 뮌헨의 예상 베스트 11을 발표했다. 포메이션은 4-2-3-1로, 최전방에 케인이 있고 2선에는 킹슬리 코만, 자말 무사우이, 세르주 그나브리가 포진한다.

 미드필더는 조슈아 키미히와 콘라드 라이머로 구성되었습니다. 수비진은 알폰소 데이비스, 김민재, 마티아스 데 리흐트, 뱅상 파바르드로 구성되었으며 골문은 스벤 울라이히가 지켰습니다. 뮌헨은 지난 시즌 실망스러운 시즌을 보냈습니다.

 바이에른은 오랫동안 분데스리가를 지배해 온 강팀이다. 지난 시즌 많은 사람들이 그들이 다시 우승할 것이라고 예측했습니다. 하지만 결과는 예상대로 나오지 않았습니다.

 도르트문트가 1위 자리를 차지했고 바이에른은 추격전을 펼쳤습니다. 엎치락뒤치락하는 리그였습니다. 도르트문트에게 패한 뮌헨은 결단을 내렸습니다.

 줄리안 나겔스만 감독을 해고하고 토마스 투헬 감독을 영입한 것입니다. 부임하자마자 투헬은 트레블을 목표로 삼겠다고 선언했습니다. 하지만 UEFA 챔피언스 리그(UCL)와 DFB 포칼 모두 8강에서 탈락했습니다.

 다행히 도르트문트는 결승에서 마인츠에 패해 리그 우승을 차지했습니다. 지난 시즌의 실망스러운 결과를 만회하기 위해 뮌헨은 선수 영입에 열을 올리고 있습니다. 바이에른은 로베르트 레반도프스키의 공백을 메워야 했습니다.

 레반도프스키가 바르셀로나로 떠나자 에릭 슈포-모팅이 그의 자리를 대신했지만 공백을 메우기에는 역부족이었습니다. 추포-모팅은 10골밖에 넣지 못했습니다. 리버풀에서 사디오 마네를 영입한 것도 실패로 돌아갔습니다.
