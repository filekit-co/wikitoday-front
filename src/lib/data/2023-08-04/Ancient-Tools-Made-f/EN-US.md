...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. Where did the iron arrowhead come from?</b></h2>
  ...
  <p>The iron arrowhead was excavated in Mörigen, a lake settlement where people were active during the Late Bronze Age.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What is the composition of the arrowhead?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>     The arrowhead contains 8.3% nickel, twice as much as the meteorite, and has a low aluminum-26 concentration and a high percentage of geranium.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q.  How many meteorite artifacts are made from meteorites?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>    According to the Bern History Museum, there are only 55 archaeological artifacts in the world that are made from meteorites.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What type of meteorite is the arrowhead believed to be made from?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>The arrowhead is believed to be made from an IAB type meteorite, which is composed of metal.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Where did the material for the arrowhead come from?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>The authors of the paper claim that the material for the arrowhead came from the Kaaliyarv meteorite, which created a huge crater on the Estonian island of Saaremaa around 1500 BC.</p>
</details>
