---
title: '댄 캠벨입니다 테디 브리지워터가 여전히 건재한지 확인해야 합니다.'
description: '라이온스의 댄 캠벨 감독은 과거에도 쿼터백 테디 브리지워터와 함께 일한 적이 있으며, 이번에도 함께 일할 예정입니다.'
category: 'Sports'
...
<blockquote class="quote-container dark">
  <p class="quote-text dark">
    라이온스의 댄 캠벨 감독은 과거에도 쿼터백 테디 브리지워터와 함께 일한 적이 있으며, 이번에도 함께 일할 예정입니다.
  </p>
</blockquote>
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. 과거에 테디 브리지워터와 함께 일한 적이 있는 사람은 누구인가요?</b></h2>
  ...
  <p>라이온스의 댄 캠벨 감독은 과거에 테디 브리지워터와 함께 일한 적이 있습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 댄 캠벨은 테디 브리지워터에 대해 뭐라고 말했나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>댄 캠벨은 제러드 고프에게 무슨 일이 생기면 브리지워터나 네이트 서드펠드가 같은 일을 할 수 있는 적임자인지 살펴볼 것이라고 말했습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 댄 캠벨은 브리지워터나 서드펠드에서 무엇을 찾고 있나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>댄 캠벨은 팀에 필요한 경우 경기에서 승리할 수 있는 최고의 기회를 제공할 수 있는 사람을 찾고 있습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 라이온스 선수 명단에는 또 누가 있나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>3라운드 지명자인 헨든 후커도 라이온스 선수 명단에 이름을 올렸습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 헨든 후커의 상황은 어떤가요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>헨든 후커는 십자인대 파열에서 회복 중이기 때문에 루키 시즌에는 레드 셔츠에 가까운 모습을 보일 것으로 보입니다.</p>
</details>
