---
title: '콜롬비아, FIFA 여자월드컵에서 자메이카를 1-0으로 꺾다'
description: '콜롬비아가 2023 FIFA 여자월드컵 16강 자메이카와의 경기에서 1-0으로 승리했습니다. 경기의 주요 장면을 소개합니다.'
category: 'Sports'
...
<blockquote class="quote-container dark">
  <p class="quote-text dark">
    콜롬비아가 2023 FIFA 여자월드컵 16강 자메이카와의 경기에서 1-0으로 승리했습니다. 경기의 주요 장면을 소개합니다.
  </p>
</blockquote>
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. 콜롬비아의 우승 골은 누가 넣었나요?</b></h2>
  ...
  <p>카탈리나 우스메가 콜롬비아의 결승골을 넣었습니다.</p>
</details>
...
<details class="group" >
  ...
  <p>콜롬비아가 자메이카를 1-0으로 꺾었습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 콜롬비아는 8강에서 누구와 맞붙게 될까요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
...
<details class="group" >
  ...
  <p>경기는 호주 멜버른 렉탱귤러 스타디움에서 열렸습니다.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. 경기의 첫 번째 예약은 어떻게 되었나요?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>자메이카의 샹텔 스와비가 경기의 첫 번째 예약을 받았습니다.</p>
</details>
