...
<details class="group" open>
  ...
  <p>고양이는 신뢰의 표시로 배를 드러내지만, 초대장이 아닌 의사소통의 한 형태이기 때문에 배를 만지면 물거나 긁을 수 있습니다.</p>
</details>
...
<details class="group" >
  ...
  <p>고양이는 요로 감염, 신장 문제, 스트레스, 더러운 쓰레기통, 익숙하지 않은 쓰레기, 새로운 반려동물이 집에 들어왔을 때 지배권을 확립하려는 경우 등 다양한 이유로 인해 쓰레기통을 사용하지 않을 수 있습니다.</p>
</details>
...
<details class="group" >
  ...
  <p>고양이는 죽은 동물을 선물로 가져오는 것을 사랑의 표시이자 사냥에 성공한 것을 인간 가족들과 공유하는 방법이라고 생각합니다.</p>
</details>
...
<details class="group" >
  ...
  <p>고양이는 담요를 자신의 것으로 표시하는 영역 행동, 본능적인 수유 행동, 스트레스나 긴장을 느낄 때 진정 행동으로 담요를 반죽합니다.</p>
</details>
...
<details class="group" >
  ...
  <p>고양이는 애정과 관심을 표현하는 방법으로 주인을 핥습니다. 또한 외로움의 신호일 수도 있으므로 주의를 기울이고 그루밍을 해주면 고양이의 정서적 욕구를 충족시키는 데 도움이 될 수 있습니다.</p>
</details>
