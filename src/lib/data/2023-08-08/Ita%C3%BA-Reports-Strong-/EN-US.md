...
<blockquote class="quote-container dark">
  <p class="quote-text dark">
    Itaú Unibanco (ITUB4) has announced impressive financial results for the second quarter of 2023, with a recurring profit of BRL 8.742 billion. However, the bank faced challenges as its app and website experienced instabilities, causing inconvenience for users.
  </p>
</blockquote>
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. What were Itaú&#39;s profits in the second quarter of 2023?</b></h2>
  ...
  <p>Itaú reported a recurring profit of BRL 8.742 billion in the second quarter of 2023, representing a 13.84% increase compared to the same period last year.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What issues did Itaú face with its app and website?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Itaú experienced instabilities with its app and website, causing inconvenience for users. The bank acknowledged the internal origin of the problem and worked urgently to restore the systems.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Did Itaú address the user complaints?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Yes, Itaú apologized to customers and partners for the inconvenience caused by the app and website instabilities. The bank restored the application for individual account holders and assured the full availability of other apps and channels.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What was Itaú&#39;s response to the instabilities?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>Itaú worked urgently to resolve the app and website instabilities. The bank remained optimistic about the future, citing the consolidation of monetary and fiscal agendas that are expected to promote economic activity.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What changes were made to Itaú&#39;s guidance for 2023?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z"/>
      </svg>
  ...
  <p>The main change in Itaú&#39;s guidance for 2023 was in the growth projection of revenues from services and insurance results. Previously expected to accelerate between 7.5% and 10.75%, the growth is now projected to be between 5% and 7%.</p>
</details>
