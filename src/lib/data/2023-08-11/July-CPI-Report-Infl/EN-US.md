---
title: 'July CPI Report: Inflation Rose 3.2% Annually'
description: 'The consumer price index in July was expected to rise 0.2% from the prior month and 3.3% from a year ago, according to Dow Jones.'
category: 'Economy'
keywords: 'CPI report, CPI'
date: '2023-08-11'
author: 'wikitoday.io'
language: 'EN-US'
...
<figure class=image-container>
    <img src="https://image.cnbcfm.com/api/v1/image/107284462-1691669243686-gettyimages-1603828834-dsc05449_ubrrozav.jpeg?v=1691670711&amp;w=1920&amp;h=1080" alt="CNBC" />
    <figcaption>
        <h4> from CNBC</h4>
    </figcaption>
</figure>
...
<details class="group" open>
  <summary class="summary">
    <h2><b>Q. What was the annual increase in the consumer price index in July?</b></h2>
  ...
  <p>The consumer price index rose 3.2% from a year ago in July.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Did the monthly price increase align with expectations?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>Prices accelerated a seasonally adjusted 0.2% for the month, in line with the Dow Jones estimate.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. What is the current 12-month rate for core CPI?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>The 12-month rate for core CPI is 4.7%, the lowest since October 2021.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. How did markets react to the CPI report?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>Markets reacted positively to the report, with futures tied to the Dow Jones Industrial Average up more than 200 points and Treasury yields mostly lower.</p>
</details>

<details class="group" >
  <summary class="summary">
    <h2><b>Q. Which category contributed the most to the monthly inflation increase?</b></h2>
    <span class="icon-container">
      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-closed" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  <p>Almost all of the monthly inflation increase came from shelter costs, which rose 0.4% and were up 7.7% from a year ago.</p>
</details>
